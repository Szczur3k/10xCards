...
import { validateChatMessages, validateChatOptions, isValidationError } from '../../../lib/services/openrouter/validators';
...
export const POST: APIRoute = async ({ request }) => {
  ...
  try {
    ...
    if (schema) {
      try {
        const response = await openRouterService.chatWithSchema(
          validatedMessages,
          schema,
          validatedOptions,
          model
