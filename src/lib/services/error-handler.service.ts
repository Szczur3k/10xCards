...
async function parseApiError(response: Response): Promise<string> {
  ...
  return getHttpStatusMessage(response.status, response.statusText);
}
 ...
 */
function getHttpStatusMessage(status: number, statusText: string): string {
 ...
 */
function handleOpenRouterError(error: OpenRouterError): string {
...
export { parseApiError, getErrorMessage, getHttpStatusMessage, handleOpenRouterError, handleError };
