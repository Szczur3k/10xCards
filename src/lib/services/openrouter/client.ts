    ...
    if (error.response) {
      ...
      switch (status) {
        ...
        case 403:
          ...
          throw new OpenRouterError(errorData.error?.message || 'Dostęp zabroniony - sprawdź uprawnienia lub treść wiadomości', 'FORBIDDEN', 403);
        case 429:
        ...
        default:
          ...
          throw new OpenRouterError(
            errorData.error?.message || 'Nieznany błąd API',
            'API_ERROR',
            status
          );
      }
